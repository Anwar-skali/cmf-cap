...
# ---------------------------------------------------------------------------
# Load app settings so we can inject the live DATABASE_URL
# ---------------------------------------------------------------------------
import sys
import os
...
config.set_main_option("sqlalchemy.url", settings.get_db_uri(sync=True))
...
import app.infrastructure.persistence.models  # noqa: E402, F401
...
def run_migrations_online() -> None:
    """Run migrations in 'online' mode — creates an Engine and associates a connection."""
