export const en = {
  ...
  workflow: {
    ...
    step1_capacity: 'Step 1: Capacity Manager',
    step1_buyer: 'Step 1: Capacity Manager',
    step1_desc: 'Project Creation & SCR',
    step2_buyer: 'Step 2: Buyer',
    step2_capacity: 'Step 2: Buyer',
    step2_desc: 'Commercial & Purchasing',
    step3_sqd: 'Step 3: SQD',
    step3_desc: 'CAT Evaluation',
    step4_complete: 'Step 4: Complete',
    step4_desc: 'Validated',
    tab_capacity: '1. Capacity Manager',
    tab_buyer: '2. Buyer',
    tab_sqd: '3. SQD Team',
