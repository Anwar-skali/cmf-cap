      ...
      <div
        className={`flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3.5 rounded-xl border text-sm font-medium ${
          ollamaActive
            ...
            : 'bg-emerald-500/5 border-emerald-400/30 text-emerald-800'
        }`}
      >
        <div className="flex items-center gap-3">
          {ollamaActive ? (
            <>
              ...
              <span>
                <span className="font-bold">✔ AI Mapping Invoked</span> — Ambiguous columns resolved by local{' '}
            ...
            <>
              ...
              <span>
                <span className="font-bold">✔ Columns Mapped Automatically</span> — Fast deterministic pipeline resolved all columns (0 AI calls required).
                {fallbackReason && fallbackReason !== 'Columns mapped automatically.' && (
